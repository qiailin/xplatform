package com.jiakun.xplatform.openapi.dao.impl;
...
public class ResponseDaoImpl extends BaseDaoImpl implements IResponseDao {
	...
	public int getResponseStatsCount(ResponseStats responseStats) {
		return (Integer) getSqlMapClientTemplate().queryForObject(
				"response.getResponseStatsCount", responseStats);
	}

	@SuppressWarnings("unchecked")
	public List<ResponseStats> getResponseStatsList(ResponseStats responseStats) {
		return (List<ResponseStats>) getSqlMapClientTemplate().queryForList(
				"response.getResponseStatsList", responseStats);
	}

	public String createResponseStats(
			final List<ResponseStats> responseStatsList) {
					...
					public Object doInSqlMapClient(SqlMapExecutor executor)
						...
						for (ResponseStats s : responseStatsList) {
							...
							sb.append(executor.insert(
									"response.createResponseStats", s));
						}
