...
public class CacheMonitorDaoImpl extends BaseDaoImpl implements
		ICacheMonitorDao {

	public int getCacheMonitorCount(CacheStats cacheStats) {
		return (Integer) getSqlMapClientTemplate().queryForObject(
				"monitor.getCacheMonitorCount", cacheStats);
	}

	@SuppressWarnings("unchecked")
	public List<CacheStats> getCacheMonitorList(CacheStats cacheStats) {
		return (List<CacheStats>) getSqlMapClientTemplate().queryForList(
				"monitor.getCacheMonitorList", cacheStats);
	}
