package com.jiakun.xplatform.data.dao.impl;
...
public class DataConfigDaoImpl extends BaseDaoImpl implements IDataConfigDao {
	...
	public int getDataConfigCount(DataConfig dataConfig) {
		return (Integer) getSqlMapClientTemplate().queryForObject(
				"data.getDataConfigCount", dataConfig);
	}

	@SuppressWarnings("unchecked")
	public List<DataConfig> getDataConfigList(DataConfig dataConfig) {
		return (List<DataConfig>) getSqlMapClientTemplate().queryForList(
				"data.getDataConfigList", dataConfig);
	}
				...
				new SqlMapClientCallback() {
					...
					public Object doInSqlMapClient(SqlMapExecutor executor)
						...
						for (DataConfig s : dataConfigList) {
							...
							sb.append(executor.insert("data.createDataConfig",
									s));
						}
	...
	public int updateDataConfig(DataConfig dataConfig) {
		return getSqlMapClientTemplate().update("data.updateDataConfig",
				dataConfig);
	}
