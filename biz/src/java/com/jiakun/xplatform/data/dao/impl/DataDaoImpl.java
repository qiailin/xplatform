...
public class DataDaoImpl extends BaseDaoImpl implements IDataDao {
	...
	public List<TabColumn> getTabColumnsByLogId(Long dataLogTotalId,
		...
		return (List<TabColumn>) getSqlMapClientTemplate().queryForList(
				"data.getTabColumns1", map);
	}
					...
					public Object doInSqlMapClient(SqlMapExecutor executor)
						...
						for (DataInfo s : dataInfoList) {
							...
							if (StringUtil.isNotEmpty(s.getSequenceValue())) {
								String v = (String) executor.queryForObject(
										"data.getSequenceValue",
										s.getSequenceValue());
								s.setValue1(v);
							}
	...
	public List<Map<String, Object>> getDataPreviewList(
		...
		return (List<Map<String, Object>>) getSqlMapClientTemplate()
				.queryForList("data.getDataPreviewList", dataLogTotal);
	}
